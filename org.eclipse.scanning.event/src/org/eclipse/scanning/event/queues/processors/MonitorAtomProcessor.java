 ...
 *            {@link MonitorAtom}.
 */
public class MonitorAtomProcessor<T extends Queueable> extends AbstractQueueProcessor<T> {

	public  MonitorAtomProcessor(T bean, IPublisher<T> publisher, boolean blocking) {
