...
public class QueueProcessorFactoryTest {
	...
	public void testRegisterProcessor() throws EventException {
		...
		QueueProcessorFactory.registerProcessors(MoveAtomProcessor.class, ScanAtomProcessor.class);
	...
	public void testReturnProcessorForAtom() throws EventException {
		QueueProcessorFactory.registerProcessors(MoveAtomProcessor.class, DummyAtomProcessor.class, DummyBeanProcessor.class);
